...
class TestModerationResult:
    ...
    def test_has_contains_pii_field(self):
        """Verify ModerationResult has contains_pii field with default"""
        result = ModerationResult(rationale="Test")
        assert hasattr(result, "contains_pii"), "ModerationResult should have a 'contains_pii' attribute"
        assert isinstance(result.contains_pii, bool), "contains_pii should be a boolean"
        assert result.contains_pii == False, "contains_pii should default to False"

    def test_has_is_unfriendly_field(self):
        """Verify ModerationResult has is_unfriendly field with default"""
        result = ModerationResult(rationale="Test")
        assert hasattr(result, "is_unfriendly"), "ModerationResult should have a 'is_unfriendly' attribute"
        assert isinstance(result.is_unfriendly, bool), "is_unfriendly should be a boolean"
        assert result.is_unfriendly == False, "is_unfriendly should default to False"

    def test_has_has_unprofessional_tone_field(self):
        """Verify ModerationResult has has_unprofessional_tone field with default"""
        result = ModerationResult(rationale="Test")
        assert hasattr(result, "has_unprofessional_tone"), "ModerationResult should have a 'has_unprofessional_tone' attribute"
        assert isinstance(result.has_unprofessional_tone, bool), "has_unprofessional_tone should be a boolean"
        assert result.has_unprofessional_tone == False, "has_unprofessional_tone should default to False"

    def test_has_is_flagged_field(self):
        """Verify ModerationResult has is_flagged field with default"""
        result = ModerationResult(rationale="Test")
        ...
        assert result.is_flagged == False, "is_flagged should default to False"
...
class TestTextModerationResult:
    ...
    def test_has_all_required_fields(self):
        ...
        assert hasattr(result, "has_unprofessional_tone"), "TextModerationResult should have 'has_unprofessional_tone' field"
    ...
    def test_all_fields_are_required(self):
        ...
        with pytest.raises(ValidationError, match="contains_pii|is_unfriendly|has_unprofessional_tone"):
...
class TestAudioModerationResult:
    ...
    def test_has_all_required_fields(self):
        ...
        assert hasattr(result, "has_unprofessional_tone"), "AudioModerationResult should have 'has_unprofessional_tone' field"
    ...
    def test_all_fields_are_required(self):
        """Verify all fields are required"""
        with pytest.raises(ValidationError, match="transcription|contains_pii|is_unfriendly|has_unprofessional_tone"):
