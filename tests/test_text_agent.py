...
async def test_moderate_text_has_required_fields():
    """Verify result has all required fields: contains_pii, is_unfriendly, has_unprofessional_tone, rationale"""
    model = _get_model()
    test_text = "Hello, thank you for contacting us."
    ...
    assert hasattr(result, 'has_unprofessional_tone'), "Result must have 'has_unprofessional_tone' field"
