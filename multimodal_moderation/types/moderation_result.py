...
class ModerationResult(BaseModel):
    ...
    has_unprofessional_tone: bool = Field(default=False, description="Whether unprofessional tone or content was detected")
    is_flagged: bool = Field(default=False, description="Whether the content is flagged for moderation")
...
class TextModerationResult(ModerationResult):
    ...
    has_unprofessional_tone: bool = Field(description="Whether unprofessional tone or content was detected")
